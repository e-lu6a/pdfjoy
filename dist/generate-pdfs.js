export function makePDF(doc, pages, colors) {
    if (colors === undefined || colors.length === 0) {
        ...
        for (let i = 0; i < pages; i++) {
            ...
            const gradient = doc.linearGradient(x, 0 - yOffset, x, doc.page.height * pages - yOffset);
...
//   };
// }
//# sourceMappingURL=generate-pdfs.js.map